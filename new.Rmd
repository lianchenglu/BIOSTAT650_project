...
ggplot(desc_stats_long[desc_stats_long$Statistic == "mean", ], aes(x = rownames(desc_stats), y = Value)) +
  geom_bar(stat = "identity") +
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
  labs(x = "Variable", y = "Mean", title = "Mean of Each Variable in selected data")

ggplot(desc_stats_long[desc_stats_long$Statistic == "sd", ], aes(x = rownames(desc_stats), y = Value)) +
  geom_bar(stat = "identity") +
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
  labs(x = "Variable", y = "sd", title = "sd of Each Variable in selected data")
```
